...
(function () {
  ...
  // Get the canonical URL from the meta tag
  const canonicalMeta = document.querySelector('meta[name="canonical-url"]');
  const refurl = canonicalMeta ? canonicalMeta.getAttribute('content') : window.location.href.replace(/#.*$/, "");
